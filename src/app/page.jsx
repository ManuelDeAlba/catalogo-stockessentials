                ...
                <div className="footer__contenedor contenedor">
                    ...
                    <div className="footer__links">
                        <Link className="footer__link" target="_blank" href="https://api.whatsapp.com/send?phone=523327306581">
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-whatsapp" width={24} height={24} viewBox="0 0 24 24" stroke-width={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <Link className="footer__link" target="_blank" href="https://www.facebook.com/midnaismera.madizonhernandez.1?mibextid=ZbWKwL">
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-facebook" width={24} height={24} viewBox="0 0 24 24" stroke-width={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
